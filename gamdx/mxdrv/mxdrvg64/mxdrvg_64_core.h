...
//
// [MXDRVg-64] 64-bit build adaptation by Rennsou1_2006 (2026):
//   Removed downsample/fmgen dependencies, fixed 62500Hz sample rate,
//   Nuked OPM / YMFM engine support. NO behavioral changes.
...
int MXDRVG_Start(
	...
	// 固定使用 X68K 原生采样率 62500Hz (64-bit 版不依赖 downsample)
	(void)samprate;
	G.SAMPRATE = 62500;
